...
const CHECKS_RU = [
  ...
  { label: "  Tail-port 1: BeaverMouse", delay: 180 },
  { label: "  Tail-port 2: BranchKeyboard", delay: 180 },
...
const CHECKS_EN = [
  { label: "BoberBIOS v2.1", delay: 200 },
  { label: "CPU: Lone Beaver 1 core @ 2.4 GHz", delay: 250 },
  { label: "Memory Test: 512 KB branches ...... OK", delay: 300 },
  { label: "Detecting IDE drives ...", delay: 200 },
  { label: "  Primary Master: Dam SSD 60 GB", delay: 200 },
  { label: "  Primary Slave: None", delay: 150 },
  { label: "  Secondary Master: Incisors DVD-ROM", delay: 200 },
  { label: "Detecting USB devices ...", delay: 200 },
  { label: "  Tail-port 1: BeaverMouse", delay: 180 },
  { label: "  Tail-port 2: BranchKeyboard", delay: 180 },
  { label: "Initializing video ... 1024x768 24bit", delay: 220 },
...
export function BiosScreen() {
  ...
  const checks = language === "en" ? CHECKS_EN : CHECKS_RU;
  ...
  const hint_text = language === "en" ? "Press DEL to enter Setup, F12 for Boot Menu" : "Press DEL to enter Setup, F12 for Boot Menu";
    ...
    <div className="fixed inset-0 z-[9999] flex flex-col bg-black px-6 py-5 font-mono text-sm text-zinc-200" style={{ fontFamily: "monospace" }}>
      <div className="border-b border-zinc-700 pb-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-zinc-500">© 2026 Beaver Inc.</span>
        </div>
        <div className="mt-0.5 text-zinc-500 text-xs">
          {language === "en" ? "An energy-aware beaver firmware" : "An energy-aware beaver firmware"}
        </div>
      </div>
